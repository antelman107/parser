...
func NewCsvParserApp(k uint32, cfg CsvParserAppConfig) *SvcParserApp {
	return &SvcParserApp{
		k:   k,
		cfg: cfg,
	}
...
func (s *SvcParserApp) getIDsTop() (top.List, error) {
...
func (s *SvcParserApp) getNamedTop(in top.List) (top.List, error) {
